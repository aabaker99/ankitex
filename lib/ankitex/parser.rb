module Ankitex
  class Parser
    ...
    # @todo change to parse one or more "theorem" commands
    #   other styles of latex formatting just need to implement this function
    #   which returns a list of objects { :front => {front}, :back => {back} }
    def self.parse_tex(tex_path)
      rv = nil
      obj = { :front => "", :back => "" }
      re = %r{\\begin\{document\}}
